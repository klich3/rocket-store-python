...
regex = GlobToRegexp("p*uck")

print("True: ", regex.match("pot luck"))
print("True: ", regex.match("pluck"))
print("True: ", regex.match("puck"))

# ----

regex = GlobToRegexp("*.min.js")

print("True: ", regex.match("http://example.com/jquery.min.js"))
print("false: ", regex.match("http://example.com/jquery.min.js.map"))

# ----

regex = GlobToRegexp("*/www/*.js")

print("True: ", regex.match("http://example.com/www/app.js"))
print("True: ", regex.match(
    "http://example.com/www/lib/factory-proxy-model-observer.js"))

# ----

regex = GlobToRegexp("*/www/{*.js,*.html}")

print("True: ", regex.match("http://example.com/www/app.js"))
print("True: ", regex.match("http://example.com/www/index.html"))
'''
...
assert_match("*.min.js", "http://example.com/jquery.min.js", **{"flags": "g"})
assert_match("*/js/*.js", "http://example.com/js/jquery.min.js",
             **{"flags": "g"})
...
assert_match("min", "http://example.com/jquery.min.js", **{"flags": "g"})
assert_match("/js/", "http://example.com/js/jquery.min.js", **{"flags": "g"})
...
assert_match("f?o", "foo", **{"extended": True,
             "globstar": True, "flags": "g"})
assert_match("f?o", "fooo", **{"extended": True,
             "globstar": True, "flags": "g"})
assert_match("f?o?", "fooo", **{"extended": True,
             "globstar": True, "flags": "g"})
assert_not_match("?fo", "fooo", **{"extended": True,
                 "globstar": True, "flags": "g"})
assert_not_match("f?oo", "foo", **{"extended": True,
                 "globstar": True, "flags": "g"})
assert_not_match("foo?", "foo", **{"extended": True,
                 "globstar": True, "flags": "g"})
...
assert_not_match("fo[oz]", "fog", **{
                 "extended": True,  "globstar": True, "flags": "g"})
...
assert_match("foo{bar,baaz}", "foobaaz", **{
             "extended": True,  "globstar": True, "flags": "g"})
assert_match("foo{bar,baaz}", "foobar", **{
             "extended": True,  "globstar": True, "flags": "g"})
assert_not_match("foo{bar,baaz}", "foobuzz", **{
                 "extended": True,  "globstar": True, "flags": "g"})
assert_match("foo{bar,b*z}", "foobuzz",
             **{"extended": True,  "globstar": True, "flags": "g"})

# More complex "extended" matches
assert_match("http://?o[oz].b*z.com/{*.js,*.html}",
             "http://foo.baaz.com/jquery.min.js",
             **{"extended": True})
assert_match("http://?o[oz].b*z.com/{*.js,*.html}",
             "http://moz.buzz.com/index.html",
             **{"extended": True})
assert_not_match("http://?o[oz].b*z.com/{*.js,*.html}",
...
assert_match(testExtStr, targetExtStr, **{
             "extended": True,  "globstar": True, "flags": "g"})
...
assert_not_match("/foo/**.txt", "/foo/bar/baz/qux.txt", **{"globstar": True})
assert_not_match("/foo/bar**/*.txt",
                 "/foo/bar/baz/qux.txt", **{"globstar": True})
...
assert_match("http://foo.com/*/*/jquery.min.js",
             "http://foo.com/bar/baz/jquery.min.js",
             **{"globstar": True})
assert_match("http://foo.com/**/jquery.min.js",
             "http://foo.com/bar/baz/jquery.min.js",
...
assert_match("http://foo.com/*/jquery.min.js",
             "http://foo.com/bar/baz/jquery.min.js",
             **{"globstar": False})
assert_not_match("http://foo.com/*/jquery.min.js",
                 "http://foo.com/bar/baz/jquery.min.js",
                 **{"globstar": True})
